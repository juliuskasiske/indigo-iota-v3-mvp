...
// A styled select built on the Radix primitive that was already a dependency.
// A native <select> cannot be styled consistently across browsers, and this is
// the one form in the product where five of them sit next to each other.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-input px-3 py-1 text-sm text-foreground shadow-sm",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-background-elevated text-foreground shadow-lg",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-sm outline-none focus:bg-background-soft focus:text-foreground",
